...
- **auth layer**: [AuthJS](https://authjs.dev/), [Clerk](https://clerk.com/), [Passport](http://www.passportjs.org/)
...
- [**Auth.js**](https://authjs.dev/): great way to setup auth on your website. (i used to recommend Auth0 but ugh, it's gotten bad)
- [**Clerk**](https://clerk.com/) if you need a cloud provider.
