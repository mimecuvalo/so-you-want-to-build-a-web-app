...
**static files**
don’t have your app serving static resources. make sure [nginx is configured](https://paper.dropbox.com/doc/the-server--ARkDoKe3PC~ZhbDAzYaFTnDAAg-Mm6TmRuzCLA6bBuw8qxKY#:h2=nginx-reverse-proxy) to serve up static files without hitting your app server.
