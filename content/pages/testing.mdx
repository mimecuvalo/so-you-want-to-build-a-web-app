...
mentioned in [CI section](https://paper.dropbox.com/doc/workflow-collaboration--AVRUDQTcBGFH~wPUW9f8pO~oAg-WTOB9n0gS6r3wmilD85Go#:uid=485397698271622042933226&h2=continuous-integration-(CI)) is the fact that you can setup a server so that you can “dogfood” your app before it goes out to the public. testing can catch a lot of things but sometimes new classes of errors can only crop up with real-world use.
