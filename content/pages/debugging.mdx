...
* **node**: `--inspect`
* **tracking errors**: exception handling, [error boundaries](https://reactjs.org/docs/error-boundaries.html), logging, [Sentry](https://sentry.io/welcome/)
* **post-mortems**
