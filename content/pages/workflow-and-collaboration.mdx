...
![i ❤ git (source)](https://d2mxuefqeaa7sj.cloudfront.net/s_606C28E372301F981B9748763858900C0B318E6B7A3FF5C1C99FF9C1C94B5AFD_1541456334331_git.jpg)
...
if you installed `zsh` and `oh-my-zsh` (from the [+🛠️ tools of the trade](https://paper.dropbox.com/doc/tools-of-the-trade-3HTOU368TrXVOAhffEQz8) chapter) then you’ll have some handy dandy shortcuts in your shell already, check them out here:
...
https://twitter.com/thisisjoshvarty/status/1027264322785832960
