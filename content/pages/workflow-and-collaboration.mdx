...
* **collaboration**:
  ...
  * **with others**: [Kind Engineering](https://kind.engineering/), [Egoless Engineering](https://egoless.engineering/), [Slack](https://slack.com/), [Dropbox Paper](https://paper.dropbox.com), [Linear](https://linear.app/), [GitHub issue tracker](https://guides.github.com/features/issues/), [tldraw](https://www.tldraw.com/)
  ...
  * **a word on open source**: [Open Source Guides](https://opensource.guide/), [6 motivations](https://opensource.com/life/15/12/why-open-source)
  * **healthy contribution**: [overview](https://help.github.com/articles/setting-up-your-project-for-healthy-contributions/), [changelog.md](https://keepachangelog.com), [code\_of\_conduct.md](https://www.contributor-covenant.org/), contributors.md, [license.md](https://choosealicense.com/), [readme.md](https://www.makeareadme.com/), [CODEOWNERS](https://help.github.com/articles/about-codeowners/), [ISSUE\_TEMPLATE](https://help.github.com/articles/about-issue-and-pull-request-templates/), [PULL\_REQUEST\_TEMPLATE](https://help.github.com/articles/creating-a-pull-request-template-for-your-repository/), [contributing.md](https://help.github.com/articles/setting-guidelines-for-repository-contributors/), acknowledgements.md, authors.md, [support.md](https://help.github.com/articles/adding-support-resources-to-your-project/)
...
for bigger teams you might consider looking at combining packages like [Commitizen](https://www.npmjs.com/package/commitizen) and [Semantic Release](https://www.npmjs.com/package/semantic-release) to help you with versioning and maintaining a changelog.
...
alternatively, there is also [yarn](https://yarnpkg.com) or [pnpm](https://pnpm.io/), which is pretty much equivalent to npm these days.
...
* **kindness**: check out [Kind Engineering](https://kind.engineering/).
* **egoless**: check out [Egoless Engineering](https://egoless.engineering/).
...
* **whiteboarding**: [tldraw](https://www.tldraw.com/)
...
* **linters**:
  * **code quality**: [ESLint](https://eslint.org/). catches issues with bugs in your code.
    * keep an eye on: [Biome](https://biomejs.dev/) and [Oxc](https://oxc.rs/).
...
* [code\_of\_conduct.md](https://www.contributor-covenant.org/)
* contributors.md
...
* [ISSUE\_TEMPLATE](https://help.github.com/articles/about-issue-and-pull-request-templates/)
* [PULL\_REQUEST\_TEMPLATE](https://help.github.com/articles/creating-a-pull-request-template-for-your-repository/)
