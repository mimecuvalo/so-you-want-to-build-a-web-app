  ...
  return (
    <Section className="flex-1">
      <Container width="small" className={`flex-1 pb-2`} size="large">
        ...
        <div data-tina-field={tinaField(props, 'author')} className="flex items-center justify-center mb-16">
          {props.author && (
            <>
      ...
      {props.heroImg && (
        <div className="px-4 w-full">
          <div data-tina-field={tinaField(props, 'heroImg')} className="relative max-w-4xl lg:max-w-5xl mx-auto">
            <img
              src={props.heroImg}
      ...
      <Container className={`flex-1 pt-4`} width="small" size="large">
        <div data-tina-field={tinaField(props, '_body')} className="prose dark:prose-dark w-full max-w-none">
